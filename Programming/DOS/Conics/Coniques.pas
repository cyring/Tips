...
{ calcule des paramŠtres de rotation. }
...
begin
     ...
     canvas.TextOut(100,50-_volumes,'ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿');
     {GotoXY(18,28-_volumes);
     canvas.TextOut(100,canvas.PenPos.Y-_volumes,_titre[langue]);
     {GotoXY(18,29-_volumes);
     canvas.TextOut(100,canvas.PenPos.Y-_volumes,'ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´');
     ...
     {GotoXY(18,31);
     canvas.TextOut(100,canvas.PenPos.Y,'ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´');
     {GotoXY(18,32);
     canvas.TextOut(100,canvas.PenPos.Y,_dispo[langue]);
     {GotoXY(18,33);
     canvas.TextOut(100,canvas.PenPos.Y,'ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ');
     {GotoXY(58,32);
